...
export class ItemChequeoMapper {
  ...
  static toEntity(domainEntity: Partial<ItemChequeo>): ItemChequeoOrmEntity {
    const ormEntity = new ItemChequeoOrmEntity();
    if (domainEntity.id_item_chequeo !== undefined)
      ormEntity.id_item_chequeo = domainEntity.id_item_chequeo;
