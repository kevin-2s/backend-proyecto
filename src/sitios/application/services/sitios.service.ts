...
export class SitiosService implements ISitiosUseCases {
  ...
  async crearSitio(data: { nombre: string; tipo: TipoSitio; tipo_personalizado?: string | null; codigo_lugar?: string | null; id_responsable?: number | null; id_centro?: number | null; estado?: boolean }): Promise<Sitio> {
